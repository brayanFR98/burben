        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="registro.php"><i class="fas fa-user"></i>&nbsp;Registrarse</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <form class="p-4 border rounded bg-light">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <button class="verpass btn btn-outline-secondary" type="button"><i
                                        class="icono fa fa-eye-slash"></i></button>
                            </div>
                        </div>


                        <button type="submit" id="loginBtn" class="btn btn-success w-100">Iniciar Sesion</button>
                    </form>
                </div>
            </div>
        </div>
